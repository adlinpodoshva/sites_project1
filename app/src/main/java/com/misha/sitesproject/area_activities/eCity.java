...
public enum eCity {
    ...
    EILAT("אילת",
            new eSite[] {eSite.AKO_TIYULE_MIDBAR, eSite.AKO_KEIF_TAYARUT_ECOLOGIT_KIBBUTZ_LOTAN, eSite.HATAR_HATAR_LEUMI_OM_RASHRASH,
    ...
    ASHDOD("אשדוד",
            new eSite[] {eSite.GIVAT_YONA, eSite.HOF_HAMITSUDA_ASHDOD, eSite.HOF_MEI_AMI, eSite.HOF_PALMACHIM,
                eSite.HOF_PALMACHIM, eSite.HOF_PALMACHIM}),
    ASHKELON("אשקלון",
