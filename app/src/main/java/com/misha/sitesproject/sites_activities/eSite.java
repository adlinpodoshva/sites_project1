...
public enum eSite {
    ...
    AIN_SHOKO("עין שוקו",214243,"tiberias", 32.73016,35.555346),
    ...
    HAR_TABOR("הר טבור", 214260, "dabburiya", 32.6866456,35.4077186),
    ...
    BATEI_HAKVAROT_HAISHANIM_BEHAIFA("בתי הקברות הישנים בחיפה", 213181, "haifa", 32.8323561, 34.9872706),
    ...
    NAHAL_ZIV_VENAHAL_REMEZ("נחל זיו ונחל רמז", 214336, "saar", 32.7969567, 35.0148303),
    NAHAL_SHIH("נחל שיח", 213181, "haifa", 32.7994936, 34.9758663),
    ...
    AIN_NON("עיןן נון", 214316, "migdal", 32.8411111, 35.5102778),
    ...
    // hermon
    BRIHAT_HAAIRUSIM("בריכת האירוסים", 212474, "netanya", 32.9993683,35.7562397),
    ...
    NAHAL_EL_AL("נחל אל על", 1869827, "natur", 32.8648029, 35.8461847),
    AIN_HAHERMON("עין החרמון", 214240, "qiryat-shemona", 33.4161617, 35.8570262),
    AIN_MUKASH("עין מוקש", 1869835, "ortal", 33.4161617, 35.8570262),
    HASHVIL_HATALYI_BEBENIAS("שביל התלוי בבניאס", 214363, "zuri%27el", 33.2472524, 35.6958925),
    ...
    PRIHAT_NARKISIM_BAEZOR_PEE_GLILOT("צובה והסטף", 215854, "tel-aviv", 32.1384648, 34.8203027),

    // hashfela
    GAN_LEUMI_HULDA("גן לאומי חולדה", 212567, "pedaya", 31.8241421,34.8932412),
    HURVAT_MIDRAS("חורבת מדרס", 213251, "zafririm", 31.654773, 34.939026),
    YAIR_MALACHIM("יער המלאכים", 215702, "qiryat-gat", 31.5994619 ,34.8390326),
    MINZAR_LATRUN("מנזר לטרון", 212557, "nahshon", 31.8327394,34.9885648),
    PARK_ANBA("פארק ענבה", 213257, "newe-shalom", 31.8983302, 35.004047),
    SHMURAT_LEEV("שמורת להב", 215735, "rahat", 31.3879473,34.8712256),
    SHMURAT_MAARAT_NESHER("שמורת מערת נשר", 213134, "en-hod", 32.7668959, 35.0595661),
    ...
    HATAR_HATAR_LEUMI_OM_RASHRASH("אתר לאומי אום רשרש", 305605, "durban", 29.54915 ,34.9555819),
